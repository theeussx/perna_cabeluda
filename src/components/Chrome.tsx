...
export default function Chrome() {
  ...
  return (
    <>
      <motion.div
        className="fixed left-0 top-0 z-[70] h-[3px] origin-left bg-gradient-to-r from-bloodsoft via-bone to-bloodsoft"
      ...
      <div className="fixed bottom-5 right-5 z-[70] flex items-center gap-2">
        <button
          ...
          className="flex items-center gap-2 border border-bone/20 bg-black/30 px-3 py-2 font-mono text-[0.78rem] uppercase tracking-[0.2em] text-bone backdrop-blur-sm transition-colors hover:border-bone/60 hover:bg-black/50 hover:text-paper"
        >
        ...
        <button
          ...
          className={
            "flex items-center gap-2 border px-3 py-2 font-mono text-[0.78rem] uppercase tracking-[0.2em] backdrop-blur-sm transition-colors " +
            (ambience.enabled
      ...
      <div className="pointer-events-none fixed bottom-5 left-5 z-[70] hidden font-mono text-[0.72rem] uppercase tracking-[0.3em] text-stone/80 sm:block">
        {meta.cornerLabel}
      </div>
    </>
  );
